...
$L['cwsender_lists_form_type_subs_desc'] = 'Для работы данного спика рассылки необходимо разместить форму подписки, разместив в любом шаблоне сайта тэг функции подписки: {PHP|cot_cwsender_subscribe(номер_рассылки)}, где номер_рассылки - это id - списка получателей рассылки.';
...
$L['cwsender_unsubscribe_status_unsubs_fail'] = 'Не удалось выполнить операцию. Пожалуйста, повторите ваш запрос или обратитесь к администратору сайта.';<?php
